...
export const metadata: Metadata = {
  title: "Insights | Metry Analytics",
  description: "Perspectivas, tendencias y aprendizajes sobre datos, analítica e IA para líderes de negocio en Guatemala y Latinoamérica.",
};
