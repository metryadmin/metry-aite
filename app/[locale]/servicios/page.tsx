...
export const metadata: Metadata = {
  title: "Servicios | Metry Analytics",
  description: "Consultoría estratégica de datos, arquitectura cloud, analítica, gobierno del dato e IA aplicada para empresas en Guatemala y Latinoamérica.",
};
