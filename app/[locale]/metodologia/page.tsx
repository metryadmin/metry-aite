...
export const metadata: Metadata = {
  title: "Metodología | Metry Analytics",
  description: "Nuestro proceso probado de 5 pasos para llevar datos e inteligencia artificial a producción con impacto real y sostenible.",
};
