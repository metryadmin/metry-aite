...
export const metadata: Metadata = {
  title: "Nosotros | Metry Analytics",
  description: "Firma estratégica de datos enfocada en diseñar, construir y gestionar capacidades de IA y datos con base en estrategia y gobierno.",
};
